...
useKunSeoMeta({
  title: '数据总览',
  description:
    '查看过去一段时间内用户, 话题, game, game 资源, game 网站, game 评论, game 网站评论的增长趋势'
})
</script>
...
<template>
  ...
  >
    <KunHeader
      name="数据总览"
      description="查看过去一段时间内用户, 话题, game, game 资源, game 网站, game 评论, game 网站评论的增长趋势。好的网站理应的开放的, 您有权利知道这个网站的一切, 当天的数据将会延时更新若干小时。"
    />
