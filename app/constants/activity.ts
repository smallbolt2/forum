export const KUN_ACTIVITY_TYPE_TYPE: Record<string, string> = {
  GALGAME_CREATION: 'Game',
  GALGAME_RATING_CREATION: 'Game 评分',
  GALGAME_RATING_COMMENT_CREATION: 'Game 评分评论',
  TOPIC_CREATION: '新话题',
  MESSAGE_UPVOTE: '话题被推',
  MESSAGE_SOLUTION: '最佳答案',
  TOPIC_REPLY_CREATION: '话题回复',
  TOPIC_COMMENT_CREATION: '话题评论',
  GALGAME_WEBSITE_CREATION: 'Game 网站',
  GALGAME_RESOURCE_CREATION: 'Game 资源',
  GALGAME_COMMENT_CREATION: 'Game 评论',
  GALGAME_PR_CREATION: 'Game 更新请求',
  GALGAME_WEBSITE_COMMENT_CREATION: 'Game 网站评论',
  TODO_CREATION: '待办',
  UPDATE_LOG_CREATION: '更新日志',
  TOOLSET_CREATION: 'Game 工具',
