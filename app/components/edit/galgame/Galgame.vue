  ...
  <div class="contents">
    <ClientOnly>
      ...
      >
        <KunHeader
          name="发布 Game"
          description="您需要创建 Game 才可以在对应的 Game 下发布 Game 资源, 如果这个 Game 已经存在, 直接在这个 Game 下添加资源即可"
        >
          <template #endContent>
        ...
        <div class="space-y-2">
          ...
          <p class="text-default-500 text-sm">
            请不要在介绍部分放置任何 图片, 我们的系统还没有开发完毕,
            之后会有专门处理图片的展示方式, 切记, 一定不要放置。
            的定义很严格, 过于的图片都视为 。一般图片尽可能少的放置,
        ...
        <KunInfo
          title="其它 Game 信息"
          description="我们在发布 Game 时会自动为您添加所有的 Game Game 会社、Game 引擎 等信息, 您无需关心这些信息"
          color="info"
        />
